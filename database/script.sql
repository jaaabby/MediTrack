...
('12345678-9', 'Administrador del Sistema', 'admin@meditrack.com', '$scrypt$N=32768,r=8,p=1$Asueit6v2c434oGgNb+efEb4rhnQyk3segfKJk+OS1Q$6OzJKrGszFBvTHwslD7Ue26y5u76oxG6i45DpHaTmqo', 'admin', 1, NULL, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('87654321-0', 'Usuario Pabellón', 'pabellon@meditrack.com', '$scrypt$N=32768,r=8,p=1$Asueit6v2c434oGgNb+efEb4rhnQyk3segfKJk+OS1Q$6OzJKrGszFBvTHwslD7Ue26y5u76oxG6i45DpHaTmqo', 'pabellón', 1, NULL, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('11111111-1', 'Encargado Bodega', 'bodegacentral@meditrack.com', '$scrypt$N=32768,r=8,p=1$Asueit6v2c434oGgNb+efEb4rhnQyk3segfKJk+OS1Q$6OzJKrGszFBvTHwslD7Ue26y5u76oxG6i45DpHaTmqo', 'encargado de bodega', 1, NULL, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('22222222-2', 'María González', 'enfermera@meditrack.com', '$scrypt$N=32768,r=8,p=1$Asueit6v2c434oGgNb+efEb4rhnQyk3segfKJk+OS1Q$6OzJKrGszFBvTHwslD7Ue26y5u76oxG6i45DpHaTmqo', 'enfermera', 1, NULL, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('33333333-3', 'Dr. Carlos Pérez', 'doctor@meditrack.com', '$scrypt$N=32768,r=8,p=1$Asueit6v2c434oGgNb+efEb4rhnQyk3segfKJk+OS1Q$6OzJKrGszFBvTHwslD7Ue26y5u76oxG6i45DpHaTmqo', 'doctor', 1, NULL, 1, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('SYSTEM-INIT', 'Sistema de Inicialización', 'system@meditrack.com', '$scrypt$N=32768,r=8,p=1$Asueit6v2c434oGgNb+efEb4rhnQyk3segfKJk+OS1Q$6OzJKrGszFBvTHwslD7Ue26y5u76oxG6i45DpHaTmqo', 'admin', 1, NULL, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('44444444-4', 'Pavedad', 'pavedad@meditrack.com', '$scrypt$N=32768,r=8,p=1$Asueit6v2c434oGgNb+efEb4rhnQyk3segfKJk+OS1Q$6OzJKrGszFBvTHwslD7Ue26y5u76oxG6i45DpHaTmqo', 'pavedad', 1, NULL, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('12121212-1', 'Usuario Consignación', 'bodegaconsignacion@meditrack.com', '$scrypt$N=32768,r=8,p=1$Asueit6v2c434oGgNb+efEb4rhnQyk3segfKJk+OS1Q$6OzJKrGszFBvTHwslD7Ue26y5u76oxG6i45DpHaTmqo', 'encargado de bodega', 1, NULL, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('55555555-5', 'Dr. Ana Martínez', 'ana.martinez@meditrack.com', '$scrypt$N=32768,r=8,p=1$Asueit6v2c434oGgNb+efEb4rhnQyk3segfKJk+OS1Q$6OzJKrGszFBvTHwslD7Ue26y5u76oxG6i45DpHaTmqo', 'doctor', 1, NULL, 2, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('66666666-6', 'Dr. Roberto Silva', 'roberto.silva@meditrack.com', '$scrypt$N=32768,r=8,p=1$Asueit6v2c434oGgNb+efEb4rhnQyk3segfKJk+OS1Q$6OzJKrGszFBvTHwslD7Ue26y5u76oxG6i45DpHaTmqo', 'doctor', 1, NULL, 4, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('77777777-7', 'Dra. Laura Torres', 'laura.torres@meditrack.com', '$scrypt$N=32768,r=8,p=1$Asueit6v2c434oGgNb+efEb4rhnQyk3segfKJk+OS1Q$6OzJKrGszFBvTHwslD7Ue26y5u76oxG6i45DpHaTmqo', 'doctor', 1, NULL, 8, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('88888888-8', 'Dr. Pedro Ramírez', 'pedro.ramirez@meditrack.com', '$scrypt$N=32768,r=8,p=1$Asueit6v2c434oGgNb+efEb4rhnQyk3segfKJk+OS1Q$6OzJKrGszFBvTHwslD7Ue26y5u76oxG6i45DpHaTmqo', 'doctor', 1, NULL, 3, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('99999999-9', 'Dra. Carmen López', 'carmen.lopez@meditrack.com', '$scrypt$N=32768,r=8,p=1$Asueit6v2c434oGgNb+efEb4rhnQyk3segfKJk+OS1Q$6OzJKrGszFBvTHwslD7Ue26y5u76oxG6i45DpHaTmqo', 'doctor', 1, NULL, 5, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('10101010-1', 'Dr. Miguel Ángel Rojas', 'miguel.rojas@meditrack.com', '$scrypt$N=32768,r=8,p=1$Asueit6v2c434oGgNb+efEb4rhnQyk3segfKJk+OS1Q$6OzJKrGszFBvTHwslD7Ue26y5u76oxG6i45DpHaTmqo', 'doctor', 1, NULL, 7, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('20202020-2', 'Dra. Patricia Vega', 'patricia.vega@meditrack.com', '$scrypt$N=32768,r=8,p=1$Asueit6v2c434oGgNb+efEb4rhnQyk3segfKJk+OS1Q$6OzJKrGszFBvTHwslD7Ue26y5u76oxG6i45DpHaTmqo', 'doctor', 2, NULL, 10, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('30303030-3', 'Dr. Fernando Castro', 'fernando.castro@meditrack.com', '$scrypt$N=32768,r=8,p=1$Asueit6v2c434oGgNb+efEb4rhnQyk3segfKJk+OS1Q$6OzJKrGszFBvTHwslD7Ue26y5u76oxG6i45DpHaTmqo', 'doctor', 2, NULL, 6, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('PABELLON1', 'Pabellón 1', 'pabellon1@meditrack.com', '$scrypt$N=32768,r=8,p=1$Asueit6v2c434oGgNb+efEb4rhnQyk3segfKJk+OS1Q$6OzJKrGszFBvTHwslD7Ue26y5u76oxG6i45DpHaTmqo', 'pabellón', 1, 1, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW()))
