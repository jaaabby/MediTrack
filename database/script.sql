...
-- ============================================================================
INSERT INTO "user" (rut, name, email, password, role, medical_center_id, pavilion_id, store_id, specialty_id, is_active, created_at, updated_at) VALUES
('12345678-9', 'Administrador del Sistema', 'admin@meditrack.com', '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'admin', 1, NULL, NULL, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('87654321-0', 'Usuario Pabellón', 'pabellon@meditrack.com', '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'pabellón', 1, NULL, NULL, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('11111111-1', 'Encargado Bodega', 'bodegacentral@meditrack.com', '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'encargado de bodega', 1, NULL, 1, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('22222222-2', 'María González', 'enfermera@meditrack.com', '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'enfermera', 1, NULL, NULL, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('33333333-3', 'Dr. Carlos Pérez', 'doctor@meditrack.com', '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'doctor', 1, NULL, NULL, 1, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('SYSTEM-INIT', 'Sistema de Inicialización', 'system@meditrack.com', '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'admin', 1, NULL, NULL, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('44444444-4', 'Pavedad', 'pavedad@meditrack.com', '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'pavedad', 1, NULL, NULL, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('12121212-1', 'Usuario Consignación', 'bodegaconsignacion@meditrack.com', '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'encargado de bodega', 1, NULL, 2, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('55555555-5', 'Dr. Ana Martínez', 'ana.martinez@meditrack.com', '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'doctor', 1, NULL, NULL, 2, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('66666666-6', 'Dr. Roberto Silva', 'roberto.silva@meditrack.com', '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'doctor', 1, NULL, NULL, 4, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('77777777-7', 'Dra. Laura Torres', 'laura.torres@meditrack.com', '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'doctor', 1, NULL, NULL, 8, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('88888888-8', 'Dr. Pedro Ramírez', 'pedro.ramirez@meditrack.com', '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'doctor', 1, NULL, NULL, 3, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('99999999-9', 'Dra. Carmen López', 'carmen.lopez@meditrack.com', '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'doctor', 1, NULL, NULL, 5, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('10101010-1', 'Dr. Miguel Ángel Rojas', 'miguel.rojas@meditrack.com', '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'doctor', 1, NULL, NULL, 7, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('20202020-2', 'Dra. Patricia Vega', 'patricia.vega@meditrack.com', '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'doctor', 2, NULL, NULL, 10, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('30303030-3', 'Dr. Fernando Castro', 'fernando.castro@meditrack.com', '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'doctor', 2, NULL, NULL, 6, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('PABELLON1',  'Pabellón 1',  'pabellon1@meditrack.com',  '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'pabellón', 1,  1,  NULL, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('PABELLON2',  'Pabellón 2',  'pabellon2@meditrack.com',  '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'pabellón', 1,  2,  NULL, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('PABELLON3',  'Pabellón 3',  'pabellon3@meditrack.com',  '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'pabellón', 1,  3,  NULL, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('PABELLON4',  'Pabellón 4',  'pabellon4@meditrack.com',  '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'pabellón', 1,  4,  NULL, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('PABELLON5',  'Pabellón 5',  'pabellon5@meditrack.com',  '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'pabellón', 1,  5,  NULL, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('PABELLON6',  'Pabellón 6',  'pabellon6@meditrack.com',  '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'pabellón', 1,  6,  NULL, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('PABELLON7',  'Pabellón 7',  'pabellon7@meditrack.com',  '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'pabellón', 1,  7,  NULL, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('PABELLON8',  'Pabellón 8',  'pabellon8@meditrack.com',  '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'pabellón', 1,  8,  NULL, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('PABELLON9',  'Pabellón 9',  'pabellon9@meditrack.com',  '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'pabellón', 1,  9,  NULL, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('PABELLON10', 'Pabellón 10', 'pabellon10@meditrack.com', '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'pabellón', 1, 10, NULL, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('PABELLON11', 'Pabellón 11', 'pabellon11@meditrack.com', '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'pabellón', 1, 11, NULL, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('PABELLON12', 'Pabellón 12', 'pabellon12@meditrack.com', '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'pabellón', 1, 12, NULL, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('PABELLON13', 'Pabellón 13', 'pabellon13@meditrack.com', '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'pabellón', 1, 13, NULL, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('PABELLON14', 'Pabellón 14', 'pabellon14@meditrack.com', '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'pabellón', 1, 14, NULL, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('PABELLON15', 'Pabellón 15', 'pabellon15@meditrack.com', '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'pabellón', 1, 15, NULL, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('PABELLON16', 'Pabellón 16', 'pabellon16@meditrack.com', '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'pabellón', 1, 16, NULL, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('PABELLON17', 'Pabellón 17', 'pabellon17@meditrack.com', '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'pabellón', 1, 17, NULL, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('PABELLON18', 'Pabellón 18', 'pabellon18@meditrack.com', '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'pabellón', 1, 18, NULL, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('PABELLON19', 'Pabellón 19', 'pabellon19@meditrack.com', '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'pabellón', 1, 19, NULL, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('PABELLON20', 'Pabellón 20', 'pabellon20@meditrack.com', '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'pabellón', 1, 20, NULL, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('PABELLON21', 'Pabellón 21', 'pabellon21@meditrack.com', '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'pabellón', 1, 21, NULL, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('PABELLON22', 'Pabellón 22', 'pabellon22@meditrack.com', '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'pabellón', 1, 22, NULL, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('PABELLON23', 'Pabellón 23', 'pabellon23@meditrack.com', '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'pabellón', 1, 23, NULL, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('PABELLON24', 'Pabellón 24', 'pabellon24@meditrack.com', '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'pabellón', 1, 24, NULL, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW())),
('PABELLON25', 'Pabellón 25', 'pabellon25@meditrack.com', '$scrypt$N=32768,r=8,p=1$LLMxrGZfHBXB/LcwwKMiSpks4Hs5p1YPrbgfM0HX4uI$wVVf1wedyurIBJ0/FTRUBZLqOn11cPJXsBaU7KdNvik', 'pabellón', 1, 25, NULL, NULL, true, EXTRACT(EPOCH FROM NOW()), EXTRACT(EPOCH FROM NOW()))
