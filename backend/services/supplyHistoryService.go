...
// GetSupplyHistoryByBatchID obtiene el historial de movimientos de los insumos de un lote específico
func (s *SupplyHistoryService) GetSupplyHistoryByBatchID(batchID int) ([]map[string]interface{}, error) {
	var results []map[string]interface{}
