          ...
          <div>
            ...
            <div class="relative">
              <input
                ...
                class="appearance-none relative block w-full px-3 py-2 pr-10 border placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-brand-blue-dark focus:border-brand-blue-dark focus:z-10 sm:text-sm"
            ...
            <p v-if="capsLockOn" class="mt-1 flex items-center gap-1 text-sm text-yellow-600 font-medium">
        ...
        <div class="flex items-center justify-between">
          ...
          <label class="flex items-center gap-2 cursor-pointer select-none">
            <input
              type="checkbox"
              v-model="rememberMe"
              class="h-4 w-4 rounded border-gray-300 text-brand-blue-dark focus:ring-brand-blue-dark"
            />
...
const handleLogin = async () => {
  ...
  try {
    await authStore.login(loginForm.email, loginForm.password, rememberMe.value)
