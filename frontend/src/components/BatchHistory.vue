  ...
  <div class="batch-history-container">
    ...
    <div class="bg-white rounded-lg shadow-sm border p-6 mb-6">
      <div class="flex items-center justify-between">
        ...
        <button @click="loadHistory" class="flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors">
    ...
    <div v-else-if="error" class="bg-red-50 border border-red-200 rounded-lg p-6 text-center">
      ...
      <button @click="loadHistory" class="mt-4 px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg">
        Intentar de nuevo
      </button>
    </div>
