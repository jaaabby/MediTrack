    ...
    <div v-else-if="analyticsData">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        <div class="bg-white rounded-lg shadow-sm border p-6">
          ...
          <div class="h-64">
            <!-- ScanPurposeChart component not implemented yet -->
            <!-- <ScanPurposeChart :data="purposeChartData" /> -->
            <div class="p-4 bg-gray-50 rounded-lg text-center text-gray-500">
              Gráfico de propósito (próximamente)
            </div>
          </div>
        </div>
      </div>
...
// import ScanTimeChart from '@/components/qr/charts/ScanTimeChart.vue'
